...
urlpatterns = [
    ...
    path('PlayList/UsersPlayList/', UsersPlayList.as_view()),
    path('PlayList/PlayListDetail/', PlayListDetail.as_view()),
    path ('PlayList/SearchPlayList/', PlayListSearch.as_view()),
